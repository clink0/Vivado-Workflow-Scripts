// Lab 8 T1 - Square problem with pushbuttons and 7-seg display
// Adapted from Pong Chu Listing 17.2 for KCPSM6 / Basys 3
//
// Button mapping:
//   btnC -> reset
//   btnL -> btn[0]: clear / re-init
//   btnR -> btn[1]: store current switch value as a or b
//
// Switch mapping:
//   sw[7:4] and sw[3:0] read by PicoBlaze when btnR pressed
//   sw[2:0] selects display: 000=a 001=b 010=a^2 011=b^2 100=a^2+b^2
...
module pico_btn_top(
    ...
    // Internal 7-seg bus from disp_mux {dp, g, f, e, d, c, b, a}
    wire [7:0] sseg_w;
    ...
    // =====================================================
    // Output interface
    //   port 0x00: ds0 (rightmost digit)
    //   port 0x01: ds1
    //   port 0x02: ds2
    //   port 0x03: ds3 (leftmost digit)
    // =====================================================
    ...
    // =====================================================
    // Input interface
    //   port 0x00: flags {6'b0, btns_flag, btnc_flag}
    //   port 0x01: switch sw[7:0]
    // =====================================================
    always @(posedge clk) begin
