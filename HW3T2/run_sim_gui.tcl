...
# Create project
create_project HW3T2 {C:\Users\lebray\Vivado-Workflow-Scripts\HW3T2\vivado_project} -part xc7a35tcpg236-1 -force
...
add_files -norecurse {C:\Users\lebray\Vivado-Workflow-Scripts\HW3T2\n_bit_comparator.v}

puts "Adding testbench files..."
add_files -fileset sim_1 -norecurse {C:\Users\lebray\Vivado-Workflow-Scripts\HW3T2\n_bit_comparator_tb.v}
add_files -fileset constrs_1 -norecurse {C:\Users\lebray\Vivado-Workflow-Scripts\Basys3_Master.xdc}
set_property top N_bit_comparator [current_fileset]
set_property top N_bit_comparator_tb [get_filesets sim_1]
